...
export default function Description(){
        ...
        <div className="description">
            ...
            <section >
                ...
                <p id="d" className="desc--text" >
                    ...
                    օրթոդոնտիայի,<br/> օրթոպեդիայի, վիրաբուժություն և այլ ծառայությունների առավելություններից:
                    <br/>Մեր նպատակն է իրագործել հաճախորդի պահանջները` լիովին ապահովելով
    ...
    //Օրթոդոնտիա, Օրթոպեդիա, Վիրաբուժություն
}